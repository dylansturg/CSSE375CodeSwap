...
public class WorkerSetup extends javax.swing.JFrame {
	...
	*/
	...
	private void initComponents() {
		...
		// SWAP 2, Team 1 
		// REFACTORING FOR ENHANCEMENT FROM BAD SMELL #7
		// Used the Extract Method to move this functionality into a separate method called initializeButtons().
		// Enhancement: breaks up the method into smaller and simpler sub-methods.
		// Refactor was a success.
		initializeButtons();
