...
public class Config extends javax.swing.JFrame {
	...
	/*
	 * CODE SMELL - Code Duplication This is quite a bit of duplication, when it
	 * could be pulled into it's own method and just call it with different
	 * parameters.
	 */

	// SWAP 2, Team 1
	// REFACTORING FOR ENHANCEMENT FROM BAD SMELL #4
	// Used Extract Method to remove duplicated code and call the method from
	// refactor #1.
	// Enhancement: Improved upon Swap 1's enhancement idea by using the
	// functionality of a previously refactored method.
	// Refactor was successful. Large part of duplicated code was removed.
	/**
	 * Used to edit days.
	 * 
	 * @param days
	...
	public Config(ArrayList<Day> days) {
		...
		for (Day day : days) {
			...
			// When refactoring numForName, the original method used a 0 indexed
			// version of days, instead of the 1 indexed version that some other
			// methods used.
			
			int dayNum = day.numForName() - 1;
			this.checkList[dayNum].doClick();
	...
	private void initComponents() {
		...
		setResizable(false);
		// SWAP 1, TEAM 10
		// Quality Change. Created single loop to initialize the check boxes
		// instead of 7 different places
		for (int i = 0; i < 7; i++) {
	...
	// SWAP 1, TEAM 10
	// Quality Change - this code was duplicated for every day of the week. Now
	// it's in just one place
	...
	// SWAP 1, TEAM 10
	// Quality Change: made a list to hold all of the necessary gui elements and
	// then they can be indexd by day. Allows for a lot of code reduction
