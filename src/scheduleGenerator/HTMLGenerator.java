...
public class HTMLGenerator {
	...
	// Used Extract Method to move the temporary fields writer and path into the writeHtml() method.
	// Enhancement. No more static fields. objects are now within the writeHtml() method.
	// Refactor successful.
	/**
